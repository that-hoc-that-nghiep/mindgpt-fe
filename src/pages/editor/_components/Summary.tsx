            ...
            <ScrollArea className="h-[32rem] p-2 border">
                <div className="space-y-4 text-sm">
                    <p>
                        ...
                        quan trọng nhất trong lịch sử Việt Nam, diễn ra vào năm
                        1954. Dưới đây là các điểm chính về chiến dịch này:
                    </p>
                    <div>
                    ...
                    <div>
                        ...
                        <p>
                            Quân đội Nhân dân Việt Nam (Việt Minh) và Quân đội
                            Pháp.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul className="list-disc list-inside">
                            <li>
                                Việt Minh: Đại tướng Võ Nguyên Giáp chỉ huy.
                            </li>
                    ...
                    <div>
                        ...
                        <p>
                            Việt Minh nhằm tiêu diệt cụm cứ điểm phòng ngự mạnh
                            của quân Pháp tại Điện Biên Phủ để kết thúc chiến
                            tranh Đông Dương.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul className="list-disc list-inside">
                            <li>
                                Việt Minh bao vây và tấn công các cứ điểm của
                                Pháp tại Điện Biên Phủ.
                            </li>
                            <li>
                                Sử dụng chiến thuật bao vây, tấn công liên tục
                                và hệ thống hầm hào để tiếp cận các cứ điểm.
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="list-disc list-inside">
                            <li>
                                Chiến thắng thuộc về Việt Minh, đánh bại hoàn
                                toàn quân Pháp tại Điện Biên Phủ.
                            </li>
                            <li>
                                Kết quả này dẫn đến việc Pháp phải ký Hiệp định
                                Genève năm 1954, chia đôi Việt Nam và rút khỏi
                                Đông Dương.
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="list-disc list-inside">
                            <li>
                                Đánh dấu sự kết thúc của cuộc chiến tranh Đông
                                Dương lần thứ nhất.
                            </li>
                            <li>
                                Khẳng định sức mạnh và chiến thuật quân sự của
                                Việt Minh.
                            </li>
                        </ul>
                    </div>
